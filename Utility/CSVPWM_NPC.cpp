...
uint8_t CSVPWM_NPC::sector_identification(float _th) {
    if (_th < 0.0f) _th += 2.0f*PI;
    m_sector = uint8_t(_th/PI_DIV_3);
    if (m_sector >= 6) m_sector = 0;
    return m_sector;
}
...
std::pair<float, float> CSVPWM_NPC::m1m2_est(std::pair<float, float> _vector){
    ...
    m_m1m2.first = _vector.first * (_cos - 1.0f/SQRT_3*_sin);
    m_m1m2.second = _vector.first * 2.0f/SQRT_3*_sin;

    return m_m1m2;
}

uint8_t CSVPWM_NPC::subsector_identification() {
    if (m_m1m2.first >= 0.5f)  return m_subsector = 0;
    if (m_m1m2.second >= 0.5f)  return m_subsector = 2;

    if (m_m1m2.first + m_m1m2.second < 0.5f){
...
void CSVPWM_NPC::ccr<0,0>(eSupplyCapacitor_t _cap){
    if (_cap == eSupplyCapacitor_t::LO){
        m_ccr[0] = 2.f*(1 - m_m1m2.first - m_m1m2.second);
        m_ccr[1] = 1;
        m_ccr[2] = 1;
        m_ccr[3] = 0;
        m_ccr[4] = 1 - 2.f*m_m1m2.second;
        m_ccr[5] = 1;
        return;
    }
    m_ccr[0] = 0;
    ...
    m_ccr[2] = 1;
    m_ccr[3] = 0;
    m_ccr[4] = 2.f*m_m1m2.first - 1;
    m_ccr[5] = 2.f*m_m1m2.first + 2.f*m_m1m2.second - 1;
}
...
void CSVPWM_NPC::ccr<0,1>(eSupplyCapacitor_t _cap){
    ...
    m_ccr[0] = 0;
    m_ccr[1] = 2.f*m_m1m2.first;
    m_ccr[2] = 1;
    m_ccr[3] = 0;
    m_ccr[4] = 0;
    m_ccr[5] = 2.f*m_m1m2.first + 2.f*m_m1m2.second - 1; // add 2*
}
...
//         m_ccr[1] = 1;
//         m_ccr[2] = 1;
//         m_ccr[3] = 1 - 2.f*m_m1m2.first - 2.f*m_m1m2.second;
//         m_ccr[4] = 1 - 2.f*m_m1m2.second; // add 2*
//         m_ccr[5] = 1;
//         return;
//     }
//     m_ccr[0] = 1 - 2.f*m_m1m2.first - 2.f*m_m1m2.second;
//     m_ccr[1] = 1 - 2.f*m_m1m2.second;
//     m_ccr[2] = 1;
//     m_ccr[3] = 0;
//     m_ccr[4] = 0;
//     m_ccr[5] = 0;
...
void CSVPWM_NPC::ccr<0,3>(eSupplyCapacitor_t _cap){
    if (_cap == eSupplyCapacitor_t::LO){
        ...
        m_ccr[2] = 1.f;
        m_ccr[3] = 0.f;
        m_ccr[4] = 2.f*m_m1m2.first;
        m_ccr[5] = 2.f*m_m1m2.first + 2.f*m_m1m2.second;
        return;
    }
    m_ccr[0] = 0.f;
    m_ccr[1] = 2.f*m_m1m2.first;
    m_ccr[2] = 2.f*m_m1m2.first + 2.f*m_m1m2.second;
    m_ccr[3] = 0.f;
    m_ccr[4] = 0.f;
    m_ccr[5] = 0.f;
}
...
void CSVPWM_NPC::ccr<1,0>(eSupplyCapacitor_t _cap){
    if (_cap == eSupplyCapacitor_t::LO){
        m_ccr[0] = 2.f*(1.f - m_m1m2.first); // fixed first
        m_ccr[1] = 2.f*(1.f - m_m1m2.first - m_m1m2.second);
        m_ccr[2] = 1.f;
        m_ccr[3] = 0.f;
        m_ccr[4] = 0.f;
        m_ccr[5] = 1.f;
    ...
    m_ccr[0] = 2.f*m_m1m2.second;
    m_ccr[1] = 0.f;
    m_ccr[2] = 1.f;
    m_ccr[3] = 0.f;
    m_ccr[4] = 0.f;
    m_ccr[5] = 2.f*m_m1m2.first + 2.f*m_m1m2.second - 1.f;
}
...
void CSVPWM_NPC::ccr<1,1>(eSupplyCapacitor_t _cap){
    if (_cap == eSupplyCapacitor_t::LO){
        ...
        m_ccr[1] = 2.f*(1.f - m_m1m2.first - m_m1m2.second);
        m_ccr[2] = 1.f;
        m_ccr[3] = 1.f - 2.f*m_m1m2.first; // fixed first
        m_ccr[4] = 0.f;
        m_ccr[5] = 1.f;
        return;
    }
...
//     m_ccr[1] = 1 - 2.f*m_m1m2.first - 2.f*m_m1m2.second;
//     m_ccr[2] = 1;
//     m_ccr[3] = 0;
//     m_ccr[4] = 0;
//     m_ccr[5] = 0;
...
void CSVPWM_NPC::ccr<2,0>(eSupplyCapacitor_t _cap){
    ...
    if (_cap == eSupplyCapacitor_t::LO){
        m_ccr[0] = 1;
        m_ccr[1] = 2.f*(1 - m_m1m2.first - m_m1m2.second);
        m_ccr[2] = 1;
        m_ccr[3] = 1;
        m_ccr[4] = 0;
    ...
    m_ccr[1] = 0;
    m_ccr[2] = 1;
    m_ccr[3] = 2.f*m_m1m2.first + 2.f*m_m1m2.second -1;
    m_ccr[4] = 0;
    m_ccr[5] = 2.f*m_m1m2.first - 1;
}
...
void CSVPWM_NPC::ccr<2,3>(eSupplyCapacitor_t _cap){
    if (_cap == eSupplyCapacitor_t::LO){
        ...
        m_ccr[1] = 1;
        m_ccr[2] = 1;
        m_ccr[3] = 2*m_m1m2.first + 2*m_m1m2.second;
        m_ccr[4] = 0;
        m_ccr[5] = 2*m_m1m2.first;
        return;
    }
    m_ccr[0] = 2*m_m1m2.first + 2*m_m1m2.second;
    m_ccr[1] = 0;
    m_ccr[2] = 2*m_m1m2.first;
    m_ccr[3] = 0;
    m_ccr[4] = 0;
...
void CSVPWM_NPC::ccr<4,3>(eSupplyCapacitor_t _cap){
    ...
    if (_cap == eSupplyCapacitor_t::LO){
        ...
        m_ccr[1] = 1;
        m_ccr[2] = 1;
        m_ccr[3] = 2*m_m1m2.first;
        m_ccr[4] = 2*m_m1m2.first + 2*m_m1m2.second;
        m_ccr[5] = 0;
        return;
    }
    m_ccr[0] = 2*m_m1m2.first;
    m_ccr[1] = 2*m_m1m2.first + 2*m_m1m2.second;
    m_ccr[2] = 0;
    m_ccr[3] = 0;
    m_ccr[4] = 0;
    m_ccr[5] = 0;
