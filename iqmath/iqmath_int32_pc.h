...
//-------------------------------------------------------------------
#define IQcos(x)        IQ(cos(IQ2FLOAT(x)))
#define IQsin(x)        IQ(sin(IQ2FLOAT(x)))
#define IQsqrt(x)       IQ(sqrt(IQ2FLOAT(x)))
#define IQatan2(y,x)    IQ(atan2(IQ2FLOAT(y), IQ2FLOAT(x)))
#define IQabs(x)        IQ(fabs(IQ2FLOAT(x)))
...
#define IQ11toF(A)      ((float)(A)*(0.0004882812))
