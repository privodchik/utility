...
//
//*****************************************************************************
#define _IQ30atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ29atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ28atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ27atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ26atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ25atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ24atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ23atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ22atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ21atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ20atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ19atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ18atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ17atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ16atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ15atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ14atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ13atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ12atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ11atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ10atan2PU(A, B)      (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ9atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ8atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ7atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ6atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ5atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ4atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ3atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ2atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQ1atan2PU(A, B)       (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
#define _IQatan2PU(A, B)        (((atan2(A, B) * (float)(1.0 / 6.283185307)) >=      \
                                  0.0f) ?                                      \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307)) :        \
                                 (atan2(A, B) * (float)(1.0 / 6.283185307) + 1.0f))
